...
function criarElemento(tag, classe, conteudo) {
  ...
  classe ? elemento.classList.add(classe) : ''; // adicionamos esse ternário para que, caso eu não coloque classe, não retorne undefined, nesse caso não retorna nada com a '', posso também colocar null
